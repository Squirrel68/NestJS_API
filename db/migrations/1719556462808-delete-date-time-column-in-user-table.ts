...
export class DeleteDateTimeColumnInUserTable1719556462808 implements MigrationInterface {
    name = 'DeleteDateTimeColumnInUserTable1719556462808'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`timesheet_entity\` DROP COLUMN \`date_time\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`task_entity\` ADD CONSTRAINT \`FK_810905c71760664b91c926035a2\` FOREIGN KEY (\`project_id\`) REFERENCES \`project_entity\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`timesheet_entity\` ADD \`date_time\` datetime NOT NULL`);
    }
