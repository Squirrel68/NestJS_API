...
export class AddRefreshTokenAndAvatarToUserTable1719804884541 implements MigrationInterface {
    name = 'AddRefreshTokenAndAvatarToUserTable1719804884541'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user_entity\` ADD \`refresh_token\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`user_entity\` ADD \`avatar\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user_entity\` DROP COLUMN \`refresh_token\``);
    }
